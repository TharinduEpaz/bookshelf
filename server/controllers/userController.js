...
const updateUserPassword = async (req, res,next) => {
    try {
        ...
        if(oldPassword === newPassword){
            throw new CustomError.BadRequestError('New password cannot be the same as old password');
        }
        ...
        res.status(statusCodes.StatusCodes.OK).json({message: 'Password updated successfully'});
